...
public class DesJsUtil {
	private String[] keys = { "www", "jrsoft", "xin" };
	private static final DesJsUtil single = new DesJsUtil();
	...
	// 静态工厂方法
	public static DesJsUtil getInstance() {
		return single;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("1--"+desObj.encode("2222.22"));
		System.out.println("2--"+desObj.decode("22"));
		//String strDe = desObj.encode("123@");
		//System.out.println(desObj.decode(strDe));
		execute();
	}
	...
	public static void   execute() throws Exception{
    	...
    	String srcFilePath = "D:\\temp\\guodiao\\cbpm\\data\\CBPM_国调_20161205.dat";
    	String desFilePath = "D:\\temp\\guodiao\\cbpm\\data\\CBPM_国调_20161205.dattt";
    	if(type.equals("1")){
    		srcFilePath = "D:\\temp\\guodiao\\cbpm\\data\\CBPM_国调_20161205.dattt";
        	desFilePath = "D:\\temp\\guodiao\\cbpm\\data\\CBPM_国调_20161205.datt";
    	}
    	...
    	String desContent = null;
    		try{
    			if(type.equals("1")){
    				desContent = DesJsUtil.getInstance().decode(content);
    			}else{
    				desContent = DesJsUtil.getInstance().encode(content);
    			}
    		...
    		System.out.println("解密后--"+DesJsUtil.getInstance().decode(desContent));
	 ...
	 * @Return String
	 */
	public String encode(String enStr) {
	 ...
	 * @Return String
	 */
	public String decode(String deStr) {
