...
public class ResultPo extends BasePo {
	...
	//首端出清电价
	private Double clearPI;
	//末端出清电价
	private Double clearPJ;
	//买卖方
	...
	public Double getClearPI() {
		return clearPI;
	}

	public void setClearPI(Double clearPI) {
		this.clearPI = clearPI;
	}

	public Double getClearPJ() {
		return clearPJ;
	}

	public void setClearPJ(Double clearPJ) {
		this.clearPJ = clearPJ;
	}
