 ...
 *
 */
@Alias("TransTielinePo")
public class TransTielinePo extends BasePo {
	...
	// 交易通道名称
	private String transCorridorName;
	// 时段
	...
	public void setTielineName(String tielineName) {
		this.tielineName = tielineName;
	}
	public String getTransCorridorName() {
		return transCorridorName;
	}
	public void setTransCorridorName(String transCorridorName) {
		this.transCorridorName = transCorridorName;
	}
